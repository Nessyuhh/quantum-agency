...
Les dix contrôles doivent être au vert. C'est l'état à retrouver à l'identique
après la bascule.
...
## 3. Contrôler les sept enregistrements, un par un
...
Les dix contrôles doivent être au vert. **Si un seul est rouge, corrigez chez
